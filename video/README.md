...
## Master v5 — 84 seconds

`red-thread-master-v5` is the motion- and sound-refined master:

1. follows a tightened chronological line from the first match in 1886 through
   1954, giving 1968, 1999 and 2008 special European-Cup status, and reaches the
   central Best/Ronaldo loop two seconds earlier;
...
Master v4 remains at `output/video/red-thread-master-v4.mp4` as the comparison
cut before the opening, effects stem and final receipt were refined.
...
to `output/video/red-thread-master-v5.mp4`; use
