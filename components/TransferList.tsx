          ...
          <li key={t.id} className="px-3.5 py-2.5 sm:px-4">
            <div className="flex items-start gap-3">
              ...
              <div className="shrink-0 text-right leading-tight">
                <div
                  className={`stat-num text-sm font-semibold tabular-nums whitespace-nowrap ${
                ...
                {t.market_value_eur != null && (
                  <div className="stat-num text-[10px] text-ink-faint" title="Transfermarkt market value at the time">
