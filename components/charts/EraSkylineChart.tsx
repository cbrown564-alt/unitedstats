...
function SkylineTooltip({
  ...
  return (
    <div className="min-w-40 rounded-md border border-line bg-panel px-3 py-2 text-xs shadow-[0_10px_30px_rgb(0_0_0_/_0.35)]">
    ...
    <div className="rounded-lg border border-line bg-pitch/40 p-3 sm:p-4">
      ...
      <div style={{ height: 132 }}>
        <ResponsiveContainer width="100%" height="100%" minWidth={0} initialDimension={{ width: 800, height: 132 }}>
          <BarChart data={data} margin={{ top: 8, right: 4, bottom: 0, left: 0 }} accessibilityLayer aria-label={`League finishes, ${label}: ${titles} titles`}>
...
export function EraSkylineChart({
  ...
  return (
    <div className="space-y-3">
      ...
      <p className="text-center text-[11px] text-ink-faint">Click a bar to open that season&apos;s matches</p>
    </div>
  );
}
