...
export function ShareCite({ path, title }: { path: string; title: string }) {
  ...
  const btn =
    "tap-target inline-flex items-center gap-1 rounded-md border border-line px-2.5 py-1.5 text-ink-dim transition-colors hover:border-devil/60 hover:text-ink focus-ring";
